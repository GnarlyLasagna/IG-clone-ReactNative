...
const ProfileScreen = () => {
  ...
  const userUid = route?.params?.otherUserUid
    ? route.params.otherUserUid
    ...
    <View style={styles.container}>
      ...
      <ScrollView style={styles.container}>
        ...
        <ProfileBio
          ...
          website={currentLoggedInUser.website}
        />
...
const ProfileBio = ({ name, email, website, bio }) => {
  return (
    <View style={styles.bioContainer}>
      ...
      {!!website && <Text style={styles.text}>{website}</Text>}
...
const ButtonsRow = ({ userEmail }) => {
  ...
  return (
    <View style={styles.buttonContainer}>
      {(isNotMe(userEmail) ? notSignedinUserButtons : signedinUserButtons).map(
        (item, index) => (
          <TouchableOpacity
            onPress={() =>
...
export const Feed = ({ posts, setModalVisible, setCurrentPostToShow }) => {
  ...
  return (
    <View style={styles.feedContainer}>
      <View style={styles.feedIcons}></View>
        ...
        {posts.map((item, index) => (
          ...
          >
            <Image
              ...
              style={{ height: width / 3.12, width: width / 3.12, margin: 2 }}
            />
          </TouchableOpacity>
        ))}
      </View>
